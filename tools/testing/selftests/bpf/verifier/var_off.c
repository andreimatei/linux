...
},
{
	...
	.result = REJECT,
	.errstr = "invalid variable-offset read from stack R2 var_off=(0xfffffffffffffff8; 0x4) size=4",
	.prog_type = BPF_PROG_TYPE_LWT_IN,
},
{
...
},
{
	...
	.errstr = "invalid unbounded variable-offset indirect write to stack access R4",
	.result = REJECT,
...
},
{
	...
	.fixup_map_hash_8b = { 5 },
	.errstr = "invalid variable-offset indirect read from stack R2 var_off=(0xfffffffffffffff8; 0x4) size=8",
	.result = REJECT,
	.prog_type = BPF_PROG_TYPE_LWT_IN,
},
{
	...
	.fixup_map_hash_8b = { 5 },
	.errstr = "invalid variable-offset indirect read from stack R2 var_off=(0xfffffffffffffc00; 0x3fc) size=8",
	.result = REJECT,
	.prog_type = BPF_PROG_TYPE_LWT_IN,
},
{
	...
	.fixup_map_hash_8b = { 5 },
	.errstr = "invalid indirect read from stack var_off (0xfffffffffffffff0; 0x4)+8 size 8",
	.result = REJECT,
	.prog_type = BPF_PROG_TYPE_LWT_IN,
},
{
	...
	.fixup_map_hash_8b = { 5 },
	.errstr = "invalid variable-offset indirect read from stack R2 var_off=(0xfffffffffffffff0; 0x4) size=8",
	.result = REJECT,
	.prog_type = BPF_PROG_TYPE_LWT_IN,
},
{
