...
},
{
	...
	.fixup_map_hash_8b = { 5 },
	.errstr = "invalid variable-offset indirect access to stack R2 var_off=(0xfffffffffffffff8; 0x4) size=8",
	.result = REJECT,
	.prog_type = BPF_PROG_TYPE_LWT_IN,
},
{
	...
	.fixup_map_hash_8b = { 5 },
	.errstr = "invalid variable-offset indirect access to stack R2 var_off=(0xfffffffffffffc00; 0x3fc) size=8",
	.result = REJECT,
	.prog_type = BPF_PROG_TYPE_LWT_IN,
},
{
	...
	.fixup_map_hash_8b = { 5 },
	.errstr = "invalid indirect read from stack R2 var_off (0xfffffffffffffff0; 0x4)+8 size 8",
	.result = REJECT,
	.prog_type = BPF_PROG_TYPE_LWT_IN,
},
{
	...
	.fixup_map_hash_8b = { 5 },
	.errstr = "invalid indirect read from stack R2 var_off (0xfffffffffffffff0; 0x4)+0 size 8",
	.result = REJECT,
	.prog_type = BPF_PROG_TYPE_LWT_IN,
},
{
